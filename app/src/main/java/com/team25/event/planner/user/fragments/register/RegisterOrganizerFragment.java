...
import com.team25.event.planner.databinding.FragmentRegisterOrganizerBinding;
import com.team25.event.planner.user.viewmodels.RegisterViewModel;

public class RegisterOrganizerFragment extends Fragment {
    private FragmentRegisterOrganizerBinding binding;
    private RegisterViewModel viewModel;
    private NavController navController;

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_register_organizer, container, false);
    ...
    private void setupObservers() {
        viewModel.formStep.observe(getViewLifecycleOwner(), formStep -> {
            ...
            if (formStep.equals(RegisterViewModel.RegisterStep.Success)) {
                navController.navigate(R.id.action_registerOrganizerFragment_to_registerSuccessFragment);
